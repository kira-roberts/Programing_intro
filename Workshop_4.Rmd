...
With copilot active, enter the following commands, accepting the promts 
...
# Ggenerate a boxplot that compares flipper_length_mm across the different species. Facet this by island, using custom color palettes.
```{r}
# Load tidyverse and palmerpenguins libraries
